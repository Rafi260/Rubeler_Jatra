...
public class UiMatchOption : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    {
        if (isConnected) { return; }
        if (!eventData.pointerCurrentRaycast.gameObject.GetComponent<UiMatchOption>())
        {
        ...
        {
            UiMatchOption matchOption = eventData.pointerCurrentRaycast.gameObject.GetComponent<UiMatchOption>();
